...
LOCK TABLES `manager_clinic` WRITE;
/*!40000 ALTER TABLE `manager_clinic` DISABLE KEYS */;
INSERT INTO `manager_clinic` VALUES (1,1),(2,2);
/*!40000 ALTER TABLE `manager_clinic` ENABLE KEYS */;
UNLOCK TABLES;
