...
(1, 1, 'user', 'Kesavan', 'male', 2, 2, '2020-02-21', 19, '2020-02-19 11:20:22', '00:00:00', 'Booking Registered.Wait for the update', 3, 'firsttime', 'video'),
...
(3, 1, 'user', 'fname', 'Male', 2, 2, '2020-02-19', 3, '2017-11-05 16:43:48', '00:00:00', 'book', 0, 'in person', '');
...
INSERT INTO `clinic` (`cid`, `name`, `address`, `fees`, `town`, `city`, `contact`, `mid`) VALUES
(1, 'Clinic', 'XYZ apartment, CST', 0, 'CST', 'Mumbai', 9999988888, '1'),
(2, 'Ram', 'jvl plaza', 0, 'cst', 'chennai', 9999999999, '2');
...
(3, 'adfasf', '', '2009-02-12', 98989, '', '', ''),
(4, 'adfasf', '', '2009-02-12', 98989, '', '', '');
